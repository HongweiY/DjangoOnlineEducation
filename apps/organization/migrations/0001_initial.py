    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_position', models.CharField(max_length=50, verbose_name='\u5c31\u804c\u516c\u53f8\u804c\u4f4d')),
                ('feature', models.CharField(max_length=30, verbose_name='\u6559\u5b66\u7279\u70b9')),
                ('collection_num', models.IntegerField(default=0, verbose_name='\u6536\u85cf\u4eba\u6570')),
                ('click_num', models.IntegerField(default=0, verbose_name='\u70b9\u51fb\u4eba\u6570')),
                ('add_time', models.DateTimeField(verbose_name=datetime.datetime.now)),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.CourseOrg', verbose_name='\u6559\u5e08\u6240\u5c5e\u673a\u6784')),
            ],
            options={
                'verbose_name': '\u6559\u5e08\u4fe1\u606f',
